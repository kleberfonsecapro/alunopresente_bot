...
from scraper_bot import scheduler as sched_mod
from scraper_bot.models import BotConfig, ExecutionLog, MessageTemplate
from scraper_bot.schemas import BotExecutionOutput, MessageOutput
...
class SchedulerFailureTest(TestCase):
    ...
    def test_execute_sem_template_registra_falha_e_notifica(self):
        ...
        with patch('scraper_bot.scheduler._notify_failure') as mock_notify:
    ...
    @patch('scraper_bot.scheduler._notify_failure')
    @patch('scraper_bot.scheduler.BotOrchestrator')
